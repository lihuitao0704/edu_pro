<template>
  <div class="dashboard-page">
    ...
    <section class="agent-directory-section">
      <header class="panel-title-row"><div><h2>Agent 管理中心</h2></div><button class="finance-secondary">查看运行日志</button></header>
    ...
    <section class="analytics-section">
      <header class="panel-title-row"><div><h2>经营与服务洞察</h2></div><span class="data-freshness">数据延迟 &lt; 5 min</span></header>
...
const pieOption: EChartsOption = {
  ...
  series: [{ type: 'pie', radius: ['48%', '72%'], label: { color: '#94a3b8', formatter: '{b}\n{d}%' }, labelLine: { lineStyle: { color: '#475569' } }, itemStyle: { borderColor: '#0f172a', borderWidth: 4 }, data: intentMix, color: ['#38bdf8', '#8b5cf6', '#f59e0b', '#34d399'] }],
}
const radarOption: EChartsOption = {
  radar: { indicator: [{ name: '适当性', max: 100 }, { name: '集中度', max: 100 }, { name: '流动性', max: 100 }, { name: '合规性', max: 100 }, { name: '预警响应', max: 100 }], axisName: { color: '#94a3b8' }, splitArea: { areaStyle: { color: ['rgba(15,23,42,.6)'] } }, splitLine: { lineStyle: { color: '#334155' } }, axisLine: { lineStyle: { color: '#334155' } } },
