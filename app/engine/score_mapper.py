...
from app.config.rules_config import SUITABILITY_MATRIX, DIMENSION_WEIGHTS
...
def map_score_to_risk_level(total_score: float) -> tuple[str, str]:
    ...
    """
    normalized = risk_level_from_score(total_score)
    return normalized.risk_level_code, normalized.risk_level_name
